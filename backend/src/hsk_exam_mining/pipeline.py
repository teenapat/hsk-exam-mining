...
def run_pipeline(root_dir: Path | None = None) -> dict:
    ...
    _sync_frontend_data(config.output_json_dir, config.frontend_public_data_dir)
...
def _sync_frontend_data(output_json_dir: Path, frontend_public_data_dir: Path) -> None:
